...
void detectObjects2()
{
    ...
    // cv::Mat img = cv::imread("../images/Cuisine.jpg");
    ...
    cv::Size size = cv::Size(320, 320); // 320 416 608
    ...
    float nmsThreshold = 0.9;  // Non-maximum suppression threshold 0.4
    vector<int> indices;
